...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--save_display_freq', type=int, default=5000,
                                 help='save the current display of results every save_display_freq_iterations')
        ...
        self.parser.add_argument('--decay_adain_affine_layers', type=bool, default=True,
                                 help='when true adain affine layer learning rate is decayed by 0.01')
        # for discriminators
        self.parser.add_argument('--n_layers_D', type=int, default=6,
                                 help='number of styled convolution layers in the discriminator')
        self.parser.add_argument('--ndf', type=int, default=64, help='# of discriminate filters in first conv layer')
        # loss weights
        self.parser.add_argument('--lambda_rec', type=float, default=10.0,
                                 help='weight for reconstruction loss')
        self.parser.add_argument('--lambda_cyc', type=float, default=10.0,
                                 help='weight for cycle loss')
        self.parser.add_argument('--lambda_oc', type=float, default=0.1, help='weight for orthogonal loss')
