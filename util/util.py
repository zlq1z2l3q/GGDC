...
males_model_spec = dict(file_url='https://drive.google.com/u/0/uc?id=1pB4mufFtzbJSxxv_2iFrBPD3vp_Ef-n3&export=download',
                        ...
                        file_path='orig_ckp/males_model.zip', file_size=213175683,
                        file_md5='0079186147ec816176b946a073d1f396')
females_model_spec = dict(
    file_url='https://drive.google.com/u/0/uc?id=1z0s_j3Khs7-352bMvz8RSnrR53vvdbiI&export=download',
...
predictor_file_spec = dict(file_url='https://drive.google.com/uc?id=1fhq5lvWy-rjrzuHdMoZfLsULvF0gJGwD',
                           ...
                           file_path='util/shape_predictor_68_face_landmarks.dat', file_size=99693937,
                           file_md5='73fde5e05226548677a050913eed4e04')
